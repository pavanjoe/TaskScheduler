...
function AboutUs() {
  ...
  return (
    <div
      className={`centered-div fade-in-element ${isAboutUsVisible ? 'visible' : ''} mt-5`}
      ref={aboutUsRef}
    >
      ...
      <p className='intro mt-3'>Welcome to our team! We are a group of enthusiastic B. Tech Computer Science students from Vellore Institute of Technology, 
        ...
        effectively. Join us on this journey as we strive to make your life more organized and productive. Get connected with us below!
      </p>
